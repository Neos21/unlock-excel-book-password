...
- 参考：[Neo's World - Excel の各種パスワードを突破する方法まとめ](https://neos21.net/blog/2016/09/30-01.html)
- 参考：[Neo's World - 読み取り専用パスワードがかけられた Excel ブックを総当たりで開こうとしてみる](https://neos21.net/blog/2016/10/13-01.html)
...
例 : `fileName=C:\UnlockExcelBookPassword\Sample.xlsx`
...
`Sample.xlsx` は、パスワード `00201` で開けるサンプルファイルです。中身は何もありませんし、スクリプト動作に必要なファイルでもありません。
